          ...
          /**/ teams.map(({ slug, title, thumbnail }) => (
            <li className="group flex aspect-video md:aspect-[2.2] rounded-lg overflow-hidden bg-9jaGreen/10 relative hofowi:-translate-y-1 hofowi:shadow-[0px_33px_15px_-29px_rgba(0,0,0,0.3)] transition duration-500">
              ...
              <Link
                ...
                to={`/teams/${'men'}`}
              >
                <p className="text-right before:bg-black  font-bold text-2xl relative before:-z-10 before:blur-md before:absolute before:w-full before:h-full">
                  {title}{' '}
                  <span className="scale-0  overflow-x-hidden group-hover:text-9jaGreen">
                    &#8594;
                  </span>
                </p>
              </Link>
